...
const Blog = ({ initialPostId, onBack })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Blog.useEffect": ()=>{
            if (!selectedPost?.content || ("TURBOPACK compile-time value", "object") === 'undefined') return;
            try {
                const parser = new DOMParser();
                const doc = parser.parseFromString(selectedPost.content, 'text/html');
                const headings = doc.querySelectorAll('h1, h2, h3');
                headings.forEach({
                    "Blog.useEffect": (heading)=>{
...
_s(Blog, "+jUthHE2BiALgin+6GewlLF63Og=");
_c = Blog;
var _c;
...
//# sourceMappingURL=_b16c28d3._.js.map